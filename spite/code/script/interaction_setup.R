...
for (k in vars){
  ...
  base2=stan("code/models/b25_agg_interaction.stan", data = dl, cores = 4, chains = 4)
  
  saveRDS(base2, paste0("data/_",k,"_gp_aggeregate_Age_inter.RDS"))
  #saveRDS(base, paste("data/",k,"gp_aggeregate_Age.RDS"))
...
for (k in vars){
  ...
  base2=stan("code/models/irt_ag_interact.stan", data = dl, cores = 4)
  saveRDS(base2, paste0("data/_",k,"_IRT_AG_interact.RDS"))
...
for (k in vars){
  ...
  base2=stan("code/models/sever_ag_interact.stan", data = dl, cores = 4)
  saveRDS(base2, paste0("data/_",k,"_years_before_25AG_interact.RDS"))
